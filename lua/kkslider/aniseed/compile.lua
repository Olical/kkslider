local _0_0 = nil
do
  local name_0_ = "kkslider.aniseed.compile"
...
local function _1_(...)
  _0_0["aniseed/local-fns"] = {require = {a = "kkslider.aniseed.core", fennel = "kkslider.aniseed.fennel", fs = "kkslider.aniseed.fs", nvim = "kkslider.aniseed.nvim"}}
  return {require("kkslider.aniseed.core"), require("kkslider.aniseed.fennel"), require("kkslider.aniseed.fs"), require("kkslider.aniseed.nvim")}
end
local _2_ = _1_(...)
local a = _2_[1]
local fennel = _2_[2]
...
do
  ...
  do
    ...
    local function macros_prefix0(code)
      local macros_module = "kkslider.aniseed.macros"
